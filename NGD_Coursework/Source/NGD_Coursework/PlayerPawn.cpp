...
void APlayerPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveUp", this, &APlayerPawn::MoveUpInput);
	PlayerInputComponent->BindAxis("MoveRight", this, &APlayerPawn::MoveRightInput);
}
...
void APlayerPawn::MoveUpInput(float Val)
{
...
void APlayerPawn::MoveRightInput(float Val)
{
